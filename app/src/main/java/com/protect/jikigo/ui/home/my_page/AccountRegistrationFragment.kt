 ...
 * Use the [AccountRegistrationFragment.newInstance] factory method to
...
class AccountRegistrationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AccountRegistrationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AccountRegistrationFragment().apply {
